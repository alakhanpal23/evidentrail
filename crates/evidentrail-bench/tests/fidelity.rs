use evidentrail_bench::{
    ...
    MethodDescriptor, NonExactFidelityDispositionV1, PinnedTransformedExpectationV1,
    RenderedCandidateArtifactV1, RepresentationFidelityErrorV1, RequirementFidelityPolicyV1,
    ReversibleEncodingIdentityV1, TokenizerIdentityV1, WeightedDiagnosticRequirementV1,
