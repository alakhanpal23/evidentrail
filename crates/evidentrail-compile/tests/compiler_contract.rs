...
use evidentrail_select::{
    PacketIdV1, ProductionFacetKindV1, SelectionConstraintV1, TotalTokenBudgetV1,
};
...
fn proposal_receipt_integer_encoding_has_a_frozen_golden_digest() {
    assert_eq!(
        ...
        &[
            0xa3, 0x32, 0x42, 0x1a, 0x46, 0x70, 0xa7, 0x79, 0x7f, 0xbc, 0xfc, 0xa7, 0xcb, 0x78,
            0x34, 0x0f, 0x94, 0x02, 0xc8, 0x9e, 0x82, 0xbf, 0x5b, 0x16, 0x66, 0x7e, 0xd7, 0xa4,
            0x99, 0x74, 0xc2, 0x5d,
        ]
    );
    assert_eq!(
        ...
        &[
            0x4d, 0x8a, 0x8c, 0x59, 0xe0, 0xff, 0xf4, 0x7d, 0x33, 0xc4, 0xbd, 0xa1, 0xff, 0x68,
            0x3f, 0x97, 0xbd, 0xc5, 0x46, 0x9f, 0x92, 0x2a, 0xf8, 0xbc, 0x86, 0xc3, 0x9f, 0x12,
            0x9d, 0xcb, 0x7d, 0xbf,
        ]
    );
    ...
    assert_eq!(
        independently_recomputed,
        [
            242, 68, 164, 25, 110, 3, 41, 207, 102, 185, 80, 135, 156, 171, 164, 228, 168, 130,
            186, 85, 99, 13, 112, 251, 207, 245, 96, 188, 151, 147, 105, 219,
        ]
    );
}
