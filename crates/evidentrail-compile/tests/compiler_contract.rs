...
fn proposal_receipt_integer_encoding_has_a_frozen_golden_digest() {
    assert_eq!(
        ...
        &[
            0x0a, 0x90, 0xf1, 0x93, 0xbe, 0xd2, 0x03, 0xcf, 0x18, 0x99, 0xdb, 0xa9, 0x17, 0xa4,
            0x37, 0x52, 0xd8, 0xa5, 0x98, 0x46, 0x42, 0x32, 0xd8, 0x7a, 0xad, 0x40, 0x66, 0xf1,
            0x48, 0xaa, 0x77, 0x94,
        ]
    );
    assert_eq!(
    ...
    assert_eq!(
        independently_recomputed,
        [
            98, 156, 40, 156, 153, 44, 74, 127, 19, 118, 210, 26, 23, 50, 97, 253, 109, 3, 122,
            171, 90, 235, 65, 110, 22, 43, 195, 88, 152, 181, 220, 122,
        ]
    );
}
