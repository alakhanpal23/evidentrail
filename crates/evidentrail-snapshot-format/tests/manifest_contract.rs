...
fn injected_key_nonce_vector_is_deterministic_and_frozen() {
    ...
    assert_eq!(
        hex(&manifest.encode()),
        ""
    );
    assert_eq!(
        hex(manifest.commitment().as_bytes()),
        "fd73e7042825449b37377509bcff1011ba1bd57531974961552a5c264c644ddc"
    );
    assert_eq!(
