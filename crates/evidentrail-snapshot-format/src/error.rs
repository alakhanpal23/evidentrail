    ...
    pub const fn code(self) -> &'static str {
        match self {
            ...
            Self::UnsupportedOuterVersion => {
                "EVIDENTRAIL_SNAPSHOT_FORMAT_UNSUPPORTED_OUTER_VERSION"
            }
            Self::UnsupportedHeaderVersion => {
                "EVIDENTRAIL_SNAPSHOT_FORMAT_UNSUPPORTED_HEADER_VERSION"
            }
            ...
            Self::InvalidSegmentChainStart => {
                "EVIDENTRAIL_SNAPSHOT_FORMAT_INVALID_SEGMENT_CHAIN_START"
            }
            Self::PlaintextTooLarge => "EVIDENTRAIL_SNAPSHOT_FORMAT_PLAINTEXT_TOO_LARGE",
            Self::PlaintextLengthMismatch => {
                "EVIDENTRAIL_SNAPSHOT_FORMAT_PLAINTEXT_LENGTH_MISMATCH"
            }
            Self::CiphertextLengthMismatch => {
                "EVIDENTRAIL_SNAPSHOT_FORMAT_CIPHERTEXT_LENGTH_MISMATCH"
            }
