...
use evidentrail_core::{
    ...
    ExpansionRelationV1, ResultId, UnixTimestampNanos, expand_retained_result_v1,
};
pub use evidentrail_core::{
    ExpandedEventV1, ExpansionLimitV1, ExpansionRequestV1, ExpansionResponseV1, ResultStoreError,
};
use evidentrail_schema::bounds::{DEFAULT_RESULT_TTL_SECS, MAX_LOG_BRIEF_EVIDENCE_PACKETS};

pub const DEFAULT_RESULT_TTL_NANOS: i128 = DEFAULT_RESULT_TTL_SECS as i128 * 1_000_000_000;
pub const MAX_EXPANSION_EVENTS: usize = evidentrail_core::MAX_EXPANSION_EVENTS;
pub const MAX_EXPANSION_BYTES: usize = evidentrail_core::MAX_EXPANSION_BYTES;
...
impl MemoryResultStore {
    ...
    pub fn expand(
        ...
        let reference = result
            ...
            .ok_or(ResultStoreError::ReferenceUnavailable)?;
        expand_retained_result_v1(&result.ledger, reference, request, now)
    }
